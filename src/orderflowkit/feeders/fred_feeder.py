...
class FredFeeder:
    """FRED adapter reserved for a post-alpha implementation."""
    ...
    def fetch(self, symbol: str, start: str, end: str, interval: str = "1d") -> pd.DataFrame:
        ...
        raise OptionalDependencyError("FredFeeder is planned but not implemented in 0.1.0")
